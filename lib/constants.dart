...
const Color kReusableCardColour = Color(0xFF1D1E33);
const Color kInactiveReusableCardColour = Color(0xFF111328);
...
const kMaxSliderHeight = 220.0;
const kMinSliderHeight = 50.0;
